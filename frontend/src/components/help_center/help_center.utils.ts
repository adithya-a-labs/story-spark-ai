...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "StorySparkAI uses advanced language models to interpret your prompt, style preferences, and narrative depth parameters to build a cohesive text layout structure automatically.",
  ...
  },
  {
    ...
    answer:
      "Yes, you can save and export your generated works into Markdown formatting or plain text documents directly from your workspace dashboard panel.",
...
export const SUPPORT_LINKS: Support_Links[] = [
  {
    ...
    description:
      "Found a bug or have a feature proposal? Track it live on our open-source project repository board.",
  ...
  },
  {
    ...
    description:
      "Chat with fellow authors, share prompt configurations, and showcase your AI-assisted lore drafts.",
...
export const SETUP_STEPS: SetupStep[] = [
  {
    ...
    description:
      "Sign up on the web platform or link your existing GitHub profile access to initialize a workspace container.",
  ...
  },
  {
    ...
    description:
      "Input your characters, genre guidelines, and setting descriptions into the processing fields.",
...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    description:
      "Learn how to effectively structure prompts and co-author with the AI engine.",
...
export const TROUBLESHOOT_ITEMS: TroubleshootItem[] = [
  {
    ...
    description:
      "Steps to resolve persistent socket dropouts or loading freezes in collab rooms.",
    icon: "fa-solid fa-wifi",
    symptoms: "Collab workspace shows connection error indicator or updates stall.",
    solution:
      "Verify your local network availability, clear application session storage, or recreate the workspace instance.",
